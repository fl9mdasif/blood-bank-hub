        ...
        <footer className="bg-gray-800 text-gray-300 border-t">
            <div className="container mx-auto px-6 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link to="/register" className="hover:text-red-500 transition-colors">Register as Donor</Link></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-gray-400">
                            ...
                            <li className="flex items-center"><Mail className="mr-3 text-red-500" size={20} /><a href="mailto:support@bloodhub.com" className="hover:text-red-500">support@bloodhub.com</a></li>
                            <li className="flex items-center"><Phone className="mr-3 text-red-500" size={20} /><a href="tel:+880123456789" className="hover:text-red-500">+880 123 456789</a></li>
                        </ul>
                    </div>
                     {/* Legal */}
                    <div>
                ...
                <div className="mt-10 border-t border-gray-700 pt-6 text-center text-sm text-gray-500">
                    <p>&copy; {new Date().getFullYear()} BloodHub. All Rights Reserved.</p>
                </div>
            </div>
        </footer>
    );
